package com.example.codeclause_simplecalculator_app;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //onclick listeners
        b1.setOnClickListener(v -> tvmain.setText(format("%s1", tvmain.getText())));
        ...
        bfact.setOnClickListener(v -> {
            ...
            tvmain.setText(valueOf(fact));
            tvsec.setText(val+"!");
        });
        bsquare.setOnClickListener(v -> {
            double d = Double.parseDouble(tvmain.getText().toString());
            double square = d*d;
            tvmain.setText(valueOf(square));
            tvsec.setText(d+"²");
        });
